                ...
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-7">
                            ...
                            <p class="m-0">Craving coffee but can’t step out? We’ve got you covered! Our efficient delivery service ensures your favorite brew reaches you quickly and hassle-free.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-7">
                            ...
                            <p class="m-0">Bring the café experience home with our freshly roasted coffee beans. Perfect for brewing your own cup of perfection anytime, anywhere.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-7">
                            ...
                            <p class="m-0">Our commitment to quality ensures every cup is crafted with precision, delivering the rich, smooth taste you love and deserve.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-7">
                            ...
                            <p class="m-0">Plan your visit in advance with our seamless online table booking. Reserve your favorite spot and enjoy a hassle-free experience.                            </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
                            ...
                            <form class="mb-5" action="reservation.DB.php" method="POST" >
                                ...
                                <div>
                                    <input class="btn btn-primary btn-block font-weight-bold py-3" type="submit">
                                </div>
                            </form>
